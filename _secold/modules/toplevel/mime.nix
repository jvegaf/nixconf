...
delib.module {
  ...
  home.ifEnabled =
    ...
    let
      safeEditor = myconfig.constants.editor or "nvim";
      safeBrowser = myconfig.constants.browser or "firefox";
      safeTerm = myconfig.constants.terminal.name or "kitty";
      safeFileManager = myconfig.constants.fileManager or "nautilus";
      ...
      myMailer =
        if (myconfig.programs.thunderbird.enable or false) then "thunderbird.desktop" else myBrowser;
